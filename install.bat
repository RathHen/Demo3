...
echo.
echo [3/5] Installing Flask, MCP, keyring, and schwab-py (real-time options)...
py -3.13 -m pip install Flask python-dotenv "mcp>=1.0.0" "keyring>=25.0.0" "schwab-py>=1.4.0"
if errorlevel 1 goto :fail
